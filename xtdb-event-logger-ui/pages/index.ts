...
<body>
  <header>
    <div class="header-top">
      <h1>📊 pi.dev Event Stream <span class="header-sep">·</span> <a href="/sessions" class="nav-link">📂 Sessions</a> <span class="header-sep">·</span> <a href="/projects" class="nav-link">📁 Projects</a> <span class="header-sep">·</span> <a href="/dashboard" class="nav-link">📊 Dashboard</a></h1>
