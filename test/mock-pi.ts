...
const KNOWN_METHODS = new Set([
  ...
  "unregisterProvider",
  "getFlag", "getActiveTools", "getAllTools", "getCommands",
  "getSessionName", "getThinkingLevel",
  "setActiveTools", "setLabel", "setModel", "setSessionName",
  "setThinkingLevel",
  "appendEntry", "exec", "sendMessage", "sendUserMessage",
]);

export interface ApiCall { method: string; args: any[] }
