...
function _safeStringify(v: unknown): string {
  try {
...
async function run() {
  // ── message_update ──
  {
    ...
    const raw = {
      ...
      assistantMessageEvent: { type: "text", delta: "hello world" },
    };
    ...
    test(
      "message_update.messageContent",
      !!fields.messageContent && fields.messageContent.includes("hello world"),
      `messageContent present=${!!fields.messageContent}`,
    );
  }
  ...
  // ── message_start ──
  {
    ...
    test(
      "message_start",
      !!fields.messageContent && fields.messageContent.includes("start msg"),
      `messageContent present=${!!fields.messageContent}`,
    );
  ...
  // ── message_end ──
  {
    ...
    test(
      "message_end",
      !!fields.messageContent && fields.messageContent.includes("end msg"),
      `messageContent present=${!!fields.messageContent}`,
    );
  }
  ...
  // ── tool_result ──
  {
    ...
    test(
      ...
      !!fields.toolContent && fields.toolContent.includes("file contents"),
      `toolContent present=${!!fields.toolContent}`,
    );
    test(
      "tool_result.toolDetails",
      !!fields.toolDetails && fields.toolDetails.includes("lineCount"),
      `toolDetails present=${!!fields.toolDetails}`,
    );
    test(
      "tool_result.toolInput",
      !!fields.toolInput && fields.toolInput.includes("/tmp/foo.ts"),
      `toolInput present=${!!fields.toolInput}`,
    );
  }
  ...
  // ── tool_execution_end ──
  {
    ...
    test(
      "tool_execution_end.toolContent",
      !!fields.toolContent && fields.toolContent.includes("cmd output"),
      `toolContent present=${!!fields.toolContent}`,
    );
    test(
      "tool_execution_end.toolDetails",
      !!fields.toolDetails && fields.toolDetails.includes("exitCode"),
      `toolDetails present=${!!fields.toolDetails}`,
    );
  }
  ...
  // ── turn_end ──
  {
    ...
    test(
      "turn_end.turnMessage",
      !!fields.turnMessage && fields.turnMessage.includes("turn response"),
      `turnMessage present=${!!fields.turnMessage}`,
    );
    test(
      "turn_end.turnToolResults",
      !!fields.turnToolResults && fields.turnToolResults.includes("result1"),
      `turnToolResults present=${!!fields.turnToolResults}`,
    );
  }
  ...
  // ── agent_end ──
  {
    ...
    test(
      "agent_end.agentMessages",
      !!fields.agentMessages && fields.agentMessages.includes("world"),
      `agentMessages present=${!!fields.agentMessages}`,
    );
  ...
  // ── tool_call ──
  {
    ...
    test(
      "tool_call.toolInput",
      !!fields.toolInput && fields.toolInput.length > 5000,
      `toolInput length=${fields.toolInput?.length} (no truncation)`,
    );
  }
  ...
  // ── tool_execution_start ──
  {
    ...
    test(
      "tool_execution_start.toolArgs",
      !!fields.toolArgs && fields.toolArgs.includes("code here"),
      `toolArgs present=${!!fields.toolArgs}`,
    );
  }
  ...
  // ── before_agent_start ──
  {
    ...
    test(
      "before_agent_start.promptText",
      !!fields.promptText && fields.promptText.length > 3000,
      `promptText length=${fields.promptText?.length} (no truncation)`,
    );
    test(
      "before_agent_start.systemPrompt",
      !!fields.systemPrompt && fields.systemPrompt.includes("helpful"),
      `systemPrompt present=${!!fields.systemPrompt}`,
    );
  ...
  // ── session_before_compact ──
  {
    ...
    test(
      "session_before_compact.compactBranchEntries",
      !!fields.compactBranchEntries && fields.compactBranchEntries.includes("e1"),
      `entries present=${!!fields.compactBranchEntries}`,
    );
  }
  ...
  // ── tool_execution_update ──
  {
    ...
    test(
      "tool_execution_update.toolArgs",
      !!fields.toolArgs && fields.toolArgs.includes("ls"),
      `toolArgs present=${!!fields.toolArgs}`,
    );
    test(
      "tool_execution_update.toolPartialResult",
      !!fields.toolPartialResult && fields.toolPartialResult.includes("partial"),
      `partialResult present=${!!fields.toolPartialResult}`,
    );
  }
  ...
  // ── context ──
  {
    ...
    test(
      ...
      !!fields.contextMessages && fields.contextMessages.includes("ctx msg"),
      `contextMessages present=${!!fields.contextMessages}`,
    );
  }
  ...
  // ── before_provider_request ──
  {
    ...
    test(
      "before_provider_request.providerPayload",
      !!fields.providerPayload && fields.providerPayload.includes("claude-3"),
      `providerPayload present=${!!fields.providerPayload}`,
    );
  }
  ...
  // ── session_fork ──
  {
    ...
    test(
      "session_fork.forkPrevious",
      fields.forkPrevious === "/tmp/old-session.json",
      `forkPrevious=${fields.forkPrevious}`,
    );
  }
  ...
  // ── session_switch ──
  {
    ...
    test(
      "session_switch.switchPrevious",
      fields.switchPrevious === "/tmp/prev.json",
      `switchPrevious=${fields.switchPrevious}`,
    );
  }
  ...
  // ── user_bash ──
  {
    ...
    test(
      "user_bash.bashCommand",
      !!fields.bashCommand && fields.bashCommand.includes("npm test"),
      `bashCommand=${fields.bashCommand}`,
    );
  ...
  const _passed = results.filter((r) => r.pass).length;
  const failed = results.filter((r) => !r.pass).length;

  if (failed > 0) {
    for (const _r of results.filter((r) => !r.pass)) {
    }
    process.exit(1);
  }
}
